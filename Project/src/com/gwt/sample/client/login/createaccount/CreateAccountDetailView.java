...
public class CreateAccountDetailView extends ViewImpl implements
	...
	public Label getEmailIdErrorLabel() {
		return emailIdErrorLabel;
	}

	public void setEmailIdErrorLabel(Label emailIdErrorLabel) {
		this.emailIdErrorLabel = emailIdErrorLabel;
	}
}
