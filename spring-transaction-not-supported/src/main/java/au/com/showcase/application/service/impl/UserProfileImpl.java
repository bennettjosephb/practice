...
public class UserProfileImpl implements UserProfile {
	...
	@Transactional
	/*
	 * UNCOMMENT THIS SECTION FOR GENERATING EXCEPTION IN
	 * idProofDao.save(idProof); SINCE THAT IS NEVER PROPAGATION
	 */
	public void save(Customer customer, IDProof idProof) {
		...
		// idProofDao.save(idProof);
		idProofDao.save(idProof); // FOR GENERATING EXCEPTION
