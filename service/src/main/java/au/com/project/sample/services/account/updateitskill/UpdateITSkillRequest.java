...
/**
 * <p>Java class for UpdateITSkillRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateITSkillRequest">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateITSkillRequest", propOrder = {
    "message"
})
public class UpdateITSkillRequest
    extends Request
{

    @XmlElement(required = true)
    protected UpdateITSkillRequest.Message message;
     ...
     * @return
     *     possible object is
     *     {@link UpdateITSkillRequest.Message }
     *     
     */
    public UpdateITSkillRequest.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(UpdateITSkillRequest.Message value) {
        this.message = value;
    }
