...
/**
 * <p>Java class for UpdateITSkillResponse complex type.
 * 
...
@XmlType(name = "UpdateITSkillResponse", propOrder = {
    "message"
})
public class UpdateITSkillResponse
    extends ResponseMessage
{

    @XmlElement(required = true)
    protected UpdateITSkillResponse.Message message;
     ...
     * @return
     *     possible object is
     *     {@link UpdateITSkillResponse.Message }
     *     
     */
    public UpdateITSkillResponse.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(UpdateITSkillResponse.Message value) {
        this.message = value;
    }
