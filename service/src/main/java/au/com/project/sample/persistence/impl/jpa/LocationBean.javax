...
import au.com.project.sample.persistence.local.LocationLocal;
import au.com.project.sample.persistence.remote.LocationRemote;
...
@Stateless
public class LocationBean implements LocationLocal, LocationRemote
{
