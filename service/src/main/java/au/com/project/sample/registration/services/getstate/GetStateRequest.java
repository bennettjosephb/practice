...
/**
 * <p>Java class for GetStateRequest complex type.
 * 
...
@XmlType(name = "GetStateRequest", propOrder = {
    "message"
})
    ...
    extends Request
{
    ...
    protected GetStateRequest.Message message;
     ...
     * @return
     *     possible object is
     *     {@link GetStateRequest.Message }
     *     
     */
    public GetStateRequest.Message getMessage() {
        return message;
    }
     ...
     *     
     */
    public void setMessage(GetStateRequest.Message value) {
        this.message = value;
    }
